...
<div/>
	...
	<a herf="#"><font color="white">EXPLORE</font></a>
 	  ...
 	  <tr>
 	 	 <span id="arrivalTime" >
 	 	 <td style="text-color:'white'"><font color="white">ARRIVAL TIME:</font></td>
 	 	 <td><input type="datetime-local" name="userarrivalTime" /></td>
 	 	 </span>
 	  </tr>
 	  <tr>
 	  	<span id="departureTime">
 	  	<td><font color="white"> DEPARTURE TIME: </font></td>
 	  	<td><input type="datetime-local" name="userdepartureTime" /></td>
 	  	 </span>
 	  </tr>
 	  <tr>
 	  	<span id="TotalTime">
 	  	<td><font color="white"> TOTAL TIME: </font></td>
 	  	<td><input type="val" name="userTime" /></td>
 	  	 </span>
 	  </tr>
 	  <tr>
 	  	 <span id="budget">
 	 	 <td><font color="white">BUDGET:</font></td>
 	 ...
 	 <tr>
 	 	<span id="citySelect">
 	  	<p id="buttons">
 	  	<td><font color="white">SELECT CITY:</font></td>
