...
<div/>
	...
	<form method="POST" action="AdminManage" name="AdminManage" class="simple_form">
		<h3 class="form-signin-heading text-muted">Sign In</h3>
		<table align="center">
			<tbody>
				<tr><td><input align="center" type="text" class="form-control" name="LoginID" id="LoginID" placeholder="Admin ID" required="" autofocus="" /></td></tr>
				<tr><td><input align="center" type="password" class="form-control" name="Pwd" id="Pwd" placeholder="Password" required="" /></td></tr>
				<tr><td><button align="center" class="btn btn-lg btn-primary btn-block" type="submit">Sign In</button></td></tr>
				<tr><td><b><font color="white">${warning}</font></b></td></tr>
			</tbody>
		</table>
	</form>
